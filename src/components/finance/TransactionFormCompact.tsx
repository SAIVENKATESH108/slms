...
interface TransactionFormCompactProps {
  clients: Client[];
...
const TransactionFormCompact: React.FC<TransactionFormCompactProps> = ({
  clients,
  onSubmit,
  onCancel,
  initialValues = {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      if (!user?.uid) {
        console.log('TransactionFormCompact: No user found, cannot fetch services');
        return;
      }
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <select
                className={`w-full px-3 py-2 border ${errors.service ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
            ...
            <div>
              ...
              <input
                ...
                min="0"
                step="1"
                className={`w-full px-3 py-2 border ${errors.amount ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
                placeholder="0"
                {...register('amount', {
            ...
            {!isPaid && !shouldShowPayNowButton() && (
              <div>
                ...
                <input
                  type="date"
                  className={`w-full px-3 py-2 border ${errors.dueDate ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent`}
...
export default TransactionFormCompact;