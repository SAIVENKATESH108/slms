...
import { format, addDays, startOfWeek, isSameDay, isToday, isTomorrow, isThisWeek, isThisMonth } from 'date-fns';
...
const ClientAppointment: React.FC = () => {
  ...
  // Check for client data in session storage on component mount
  useEffect(() => {
    ...
    if (storedClientData) {
      try {
        ...
        console.error('Error parsing client data from session storage:', error);
  ...
  return <AppointmentBooking clientData={clientData} onLogout={handleLogout} />;
};
